...
class ActivateProduction_ActionStateTest {
    ...
    @ParameterizedTest
    @EnumSource(value = Packet.InstructionCode.class, names = {"RES_FROM_DEPOT", "RES_FROM_STRONG", "RES_FROM_CARD"})
    void BaseTest(Packet.InstructionCode istr){
        game.changeTurn();
        ...
        switch (istr){
            case RES_FROM_DEPOT:
                game.getCurrentPlayer().getWarehouse().add(1,new Resource(FinalResource.ResourceType.COIN,2));
                game.getCurrentPlayer().getWarehouse().add(1,new Resource(FinalResource.ResourceType.COIN,2));


                arg2.add(1);

                Packet packet2=new Packet(istr,null,arg2);
            ...
            case RES_FROM_STRONG:
                ...
                Packet packet3=new Packet(istr,null,arg2);
            ...
            case RES_FROM_CARD:
                ...
                Packet packet4=new Packet(istr,null,arg2);
        ...
        arg3.add(new Resource(FinalResource.ResourceType.SHIELD,1));

        Packet packet5=new Packet(CHOOSE_RES,null,arg3);
    ...
    @ParameterizedTest
    @EnumSource(value = Packet.InstructionCode.class, names = {"RES_FROM_DEPOT", "RES_FROM_STRONG", "RES_FROM_CARD"})
    void BaseTestIWantFaith(Packet.InstructionCode istr){
        game.changeTurn();
        ...
        ArrayList<Object> arg3 =new ArrayList<>();
        arg3.add(new Resource(FinalResource.ResourceType.FAITH,1));
    ...
    @ParameterizedTest
    @EnumSource(value = Packet.InstructionCode.class, names = {"RES_FROM_DEPOT", "RES_FROM_STRONG", "RES_FROM_CARD"})
    void BaseTestIWantBlank(Packet.InstructionCode istr){
        game.changeTurn();
        ...
        ArrayList<Object> arg3 =new ArrayList<>();
        arg3.add(new Resource(FinalResource.ResourceType.BLANK,1));
    ...
    @ParameterizedTest
    @EnumSource(value = Packet.InstructionCode.class, names = {"RES_FROM_DEPOT", "RES_FROM_STRONG", "RES_FROM_CARD"})
    void BaseTestWrongAmount(Packet.InstructionCode istr){
        game.changeTurn();
        ...
        assertDoesNotThrow(() -> {
            switch (istr){
                case RES_FROM_DEPOT:
                    game.getCurrentPlayer().getWarehouse().add(2,new Resource(FinalResource.ResourceType.COIN,2));
                    game.getCurrentPlayer().getWarehouse().add(2,new Resource(FinalResource.ResourceType.COIN,2));
                    game.getCurrentPlayer().getWarehouse().add(2,new Resource(FinalResource.ResourceType.COIN,2));
                    ...
                    break;
                case RES_FROM_STRONG:
                    game.getCurrentPlayer().getStrongbox().addResources(FinalResource.ResourceType.COIN,3);
    ...
    @ParameterizedTest
    @EnumSource(value = Packet.InstructionCode.class, names = {"RES_FROM_DEPOT", "RES_FROM_STRONG", "RES_FROM_CARD"})
    void BaseTestWrongResourcesInsertLikeBlank(Packet.InstructionCode istr){
        game.changeTurn();
        ...
        InvalidArgumentsException e = assertThrows(InvalidArgumentsException.class, () -> {
            switch (istr){
                case RES_FROM_DEPOT:
                    game.getCurrentPlayer().getWarehouse().add(1,new Resource(FinalResource.ResourceType.BLANK,2));
                    game.getCurrentPlayer().getWarehouse().add(1,new Resource(FinalResource.ResourceType.BLANK,2));
                    ...
                    break;
                case RES_FROM_STRONG:
                    game.getCurrentPlayer().getStrongbox().addResources(FinalResource.ResourceType.BLANK,2);
                    ...
                    assertTrue(deepEquals(0,game.getCurrentPlayer().getStrongbox().getAmount(FinalResource.ResourceType.BLANK)));

                    break;
                case RES_FROM_CARD:
                    ArrayList<LeadCard> cards = new ArrayList<>();
                    LeadCard cardL = new LeadCard("leadercard_front_2_1", 3, null, null, Ability.AbilityType.DEPOT, FinalResource.ResourceType.BLANK, true);
                    cardL.setupAbility();
    ...
    @Test
    void TestProductionFromDepotWrongAmount(){
    ...
    @Test
    void TestProductionFromWrongResource(){
    ...
    @Test
    void TestProductionFromRES_FROM_STRONG_WrongAmount(){
        ...
        assertDoesNotThrow(() -> {
            switch (card.getID()) {
                case "developmentcard_front_g_1_1":
                    ...
                    game.getCurrentPlayer().getStrongbox().addResources(FinalResource.ResourceType.COIN,2);
                    ArrayList<Object> arg2 = new ArrayList<>();
                    arg2.add(new Resource(FinalResource.ResourceType.COIN,2));
                ...
                case "developmentcard_front_g_1_2":
                    System.out.println(2);
                    game.getCurrentPlayer().getStrongbox().addResources(FinalResource.ResourceType.STONE,2);
                    ArrayList<Object> arg3 = new ArrayList<>();
                    arg3.add(new Resource(FinalResource.ResourceType.STONE,2));
                ...
                case "developmentcard_front_g_1_4":
                    ...
                    ArrayList<Object> arg5 = new ArrayList<>();
                    arg5.add(new Resource(FinalResource.ResourceType.STONE,2));
    ...
    @Test
    void TestProductionFromRES_FROM_STRONG_WrongResource(){
        ...
        assertDoesNotThrow(() -> {
            switch (card.getID()) {
                case "developmentcard_front_g_1_1":
                    ...
                    game.getCurrentPlayer().getStrongbox().addResources(FinalResource.ResourceType.STONE,1);
                    ArrayList<Object> arg2 = new ArrayList<>();
                    arg2.add(new Resource(FinalResource.ResourceType.STONE,1));
                ...
                case "developmentcard_front_g_1_3":
                    ...
                    ArrayList<Object> arg4 = new ArrayList<>();
                    arg4.add(new Resource(FinalResource.ResourceType.COIN,1));
                ...
                case "developmentcard_front_g_1_4":
                    ...
                    ArrayList<Object> arg5 = new ArrayList<>();
                    arg5.add(new Resource(FinalResource.ResourceType.COIN,1));
    ...
    @Test
    void TestProductionFromRES_FROM_CARD_WRONGAMOUNT(){
    ...
    @Test
    void TestProductionFromRES_FROM_CARD_WRONGRESOURCES(){
        ...
        assertDoesNotThrow(() -> {
            switch (card.getID()) {
                case "developmentcard_front_g_1_1":
                    System.out.println(1);
                    ArrayList<LeadCard> cards = new ArrayList<>();
                    LeadCard cardL = new LeadCard("leadercard_front_2_1", 3, null, null, Ability.AbilityType.DEPOT, FinalResource.ResourceType.SHIELD, true);
                    cardL.setupAbility();
                ...
                case "developmentcard_front_g_1_2":
                    System.out.println(2);
                    ArrayList<LeadCard> cards1 = new ArrayList<>();
                    LeadCard cardL1 = new LeadCard("leadercard_front_2_1", 3, null, null, Ability.AbilityType.DEPOT, FinalResource.ResourceType.COIN, true);
                    cardL1.setupAbility();
                ...
                case "developmentcard_front_g_1_3":
                    System.out.println(3);
                    ArrayList<LeadCard> cards2 = new ArrayList<>();
                    LeadCard cardL2 = new LeadCard("leadercard_front_2_1", 3, null, null, Ability.AbilityType.DEPOT, FinalResource.ResourceType.COIN, true);
                    cardL2.setupAbility();
                ...
                case "developmentcard_front_g_1_4":
                    ...
                    ArrayList<LeadCard> cards3 = new ArrayList<>();
                    LeadCard cardL3 = new LeadCard("leadercard_front_2_1", 3, null, null, Ability.AbilityType.DEPOT, FinalResource.ResourceType.COIN, true);
                    cardL3.setupAbility();
    ...
    void LeadCardProduction(FinalResource.ResourceType res){
        Action action = new Action();
        action.setActionState(new ActivateProduction_ActionState(action), ACT_PROD);
        ...
        assertTrue(deepEquals(1,game.getCurrentPlayer().getStrongbox().getAmount(res)));
        assertTrue(deepEquals(1,game.getCurrentPlayer().getFaithPosition()));
    ...
    void LeadCardProductionWrongResources(FinalResource.ResourceType res){
        Action action = new Action();
        action.setActionState(new ActivateProduction_ActionState(action), ACT_PROD);
